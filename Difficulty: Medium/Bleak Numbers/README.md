<h2><a href="https://www.geeksforgeeks.org/problems/bleak-numbers1552/1?itm_source=geeksforgeeks&itm_medium=article&itm_campaign=practice_card">Bleak Numbers</a></h2><h3>Difficulty Level : Difficulty: Medium</h3><hr><div class="problems_problem_content__Xm_eO"><p><span style="font-size: 18px;">Given an integer, check whether it is <strong>Bleak or not</strong>. </span></p>
<p><span style="font-size: 18px;">A number n is called Bleak if it <strong>cannot </strong>be represented as sum of a positive number x and set bit count in x, i.e., x + <a href="http://www.geeksforgeeks.org/count-set-bits-in-an-integer/" previewlistener="true">countSetBits(x)</a> is not equal to n for any non-negative number x.</span></p>
